...
function Index() {
	return (
		...
		<div name='home' className="w-full h-full  bg-bgprim  flex flex-col items-center justify-center pt-20 selection:bg-primary selection:text-bgprim">
			<main className="w-full h-full  bg-bgprim flex  items-center justify-center flex-wrap-reverse  px-4  xl:justify-between xl:pt-2 xl:pb-16">
				<div className="text-primary  font-poppins text-center xl:pb-4 xl:pl-[5rem] flex flex-col justify-start items-center xl:items-start ">
					...
					<Link  to='about' smooth={true} duration={500}>
						<div className="bg-primary text-bgprim cursor-pointer h-10 w-28 group flex justify-center items-center gap-1 font-semibold">
							Know More{' '}
